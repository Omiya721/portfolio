...
function my_theme_enqueue_scripts() {
    ...
    wp_enqueue_script('luminous', 'https://cdnjs.cloudflare.com/ajax/libs/luminous-lightbox/2.3.2/Luminous.min.js', array(), null, true);
    wp_enqueue_script('luminous-gallery', 'https://cdnjs.cloudflare.com/ajax/libs/luminous-lightbox/2.3.2/LuminousGallery.min.js', array('luminous'), null, true);
